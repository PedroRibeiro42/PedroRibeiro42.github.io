...
using namespace std;  // Para não ser necessário escrever std::set, std::map, etc
...
int main() {
  ...
  s.insert(6);
  s.insert(8);
  // O cast (int) é para converter, visto que size() retorna size_type que
  // é realmente um long unsigned int
  printf("Tamanho: %d\n", (int)s.size()); 
  ...
  // "auto" implica que a variável fica com o tipo determinado automaticamente
